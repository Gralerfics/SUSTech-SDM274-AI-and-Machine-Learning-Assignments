    ...
    <div class="model-builder">
        <div class="building-zone">
            ...
            >
                ...
                <div v-if="Object.keys(block.params).length > 0">
                    <hr />
                    <div v-for="(value, key) in block.params" class="params">
...
const modelBlocks = ref([])

function onUpdate() {
    console.log('Updated model structure')
    console.log(modelBlocks.value)
}
...
function addBlock(type) {
    ...
    switch (type) {
        case 'Linear':
            newBlock = {type: 'Linear', params: {in_dims: 1, out_dims: 1}}
            break
        case 'Sigmoid':
    ...
    modelBlocks.value.push(newBlock)
}

function removeBlock(index) {
    modelBlocks.value.splice(index, 1)
}
</script>
